...
void minimum(int grades[][EXAMS], int pup, int test);
void maximum(int grades[][EXAMS], int pup, int test);
...
void main()
{
	void(*processGrages[4])(int[][EXAMS], int, int) = { printarr,minimum,maximum,ave };
	int choice = 0;
